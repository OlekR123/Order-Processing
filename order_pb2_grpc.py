...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.OrderStatusStream = channel.unary_stream(
                '/order.OrderService/OrderStatusStream',
                request_serializer=order__pb2.ListOrdersRequest.SerializeToString,
                response_deserializer=order__pb2.OrderStatusUpdate.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'OrderStatusStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.ListOrdersRequest.FromString,
                    response_serializer=order__pb2.OrderStatusUpdate.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def OrderStatusStream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/order.OrderService/OrderStatusStream',
            order__pb2.ListOrdersRequest.SerializeToString,
            order__pb2.OrderStatusUpdate.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
